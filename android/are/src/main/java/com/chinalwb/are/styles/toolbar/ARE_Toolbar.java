...
public class ARE_Toolbar extends LinearLayout {
    ...
    private void initViews() {
        ...
        this.mTxtDone = this.findViewById(R.id.txt_done);
        this.mTxtDone.setOnClickListener(new OnClickListener() {
            @Override
    ...
    public void setDoneListener(ARE_Toolbar.DoneListener doneListener) {
